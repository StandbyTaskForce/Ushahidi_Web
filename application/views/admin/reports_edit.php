				...
				<?php print form::open(NULL, array('enctype' => 'multipart/form-data', 'id' => 'reportForm', 'name' => 'reportForm')); ?>
					...
					<div class="report-form">
						...
						<div class="f-col">
							...
							<div class="row">
								<h4><?php echo Kohana::lang('ui_main.description') . ' <span class="required">*</span>';?> <span><?php echo Kohana::lang('ui_main.include_detail');?>.</span></h4>
							...
							<div class="row">
								<h4><a href="#" id="category_toggle" class="new-cat"><?php echo Kohana::lang('ui_main.new_category');?></a><?php echo Kohana::lang('ui_main.categories') . ' <span class="required">*</span>';?> 
